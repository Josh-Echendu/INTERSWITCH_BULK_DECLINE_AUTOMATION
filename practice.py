...
def process_disputes(driver, wait):
...
def _refresh(driver, wait):
    try:
        print("Refreshing browser...")
        driver.refresh()

        # to avoid using time.sleep()
...
#         # this code is not redundant, its a wait mechinsm for all buttons to load unless no button would load
#         wait.until(EC.element_to_be_clickable((By.XPATH, "//div[@class='dispute-modal-actions']/button")))
